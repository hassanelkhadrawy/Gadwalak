...
public class TaskDoneAdapter extends ArrayAdapter<Task> {

    public TaskDoneAdapter(Activity context, ArrayList<Task> Tasks) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.task_done_list_item, parent, false);
        }
        ...
        int magnitudeColor = ContextCompat.getColor(getContext(), R.color.magnitudeDone);
